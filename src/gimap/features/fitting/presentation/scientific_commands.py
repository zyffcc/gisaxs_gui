...
COMPONENT_PARAMETER_SCHEMAS = {
    "Sphere": [
        ("intensity", "Int", "Intensity", 1.0, 12, 0.1),
        ("radius", "R", "Radius (nm)", 10.0, 12, 0.1),
        ("sigma_radius", "SigmaR", "sigma Radius", 0.1, 12, 0.01),
        ("diameter", "D", "D spacing (nm)", 20.0, 12, 0.1),
        ("sigma_diameter", "SigmaD", "sigma D", 0.1, 12, 0.01),
    ],
    "Cylinder": [
        ("intensity", "Int", "Intensity", 1.0, 12, 0.1),
        ("radius", "R", "Radius (nm)", 10.0, 12, 0.1),
        ("sigma_radius", "SigmaR", "sigma Radius", 0.1, 12, 0.01),
        ("height", "h", "Height (nm)", 20.0, 12, 0.1),
        ("sigma_height", "Sigmah", "sigma Height", 0.1, 12, 0.01),
        ("diameter", "D", "D spacing (nm)", 20.0, 12, 0.1),
        ("sigma_diameter", "SigmaD", "sigma D", 0.1, 12, 0.01),
    ],
    "Vertical Cylinder": [
        ("intensity", "Int", "Intensity", 1.0, 12, 0.1),
        ("radius", "R", "Radius (nm)", 10.0, 12, 0.1),
        ("sigma_radius", "SigmaR", "sigma Radius / R", 0.3, 12, 0.01),
        ("diameter", "D", "D spacing (nm)", 20.0, 12, 0.1),
        ("sigma_diameter", "SigmaD", "sigma D", 0.1, 12, 0.01),
    ],
}
