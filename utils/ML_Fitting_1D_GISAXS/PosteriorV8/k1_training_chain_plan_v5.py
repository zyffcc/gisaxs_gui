...
K1_TRAINING_REQUIRED_SOURCE_FILES = (
    ...
    POSTERIOR_ROOT_RELATIVE / "k1_training_identity_contract_v5.py",
    POSTERIOR_ROOT_RELATIVE / "k1_training_identity_runtime_v5.py",
    ...
    POSTERIOR_ROOT_RELATIVE / "tuning_checkpoint_model_v5.py",
    POSTERIOR_ROOT_RELATIVE / "universal_tuning_adapter_v5.py",
    POSTERIOR_ROOT_RELATIVE / "tuning_search_recorder_v5.py",
    POSTERIOR_ROOT_RELATIVE / "tuning_checkpoint_runtime_v5.py",
    POSTERIOR_ROOT_RELATIVE / "tuning_checkpoint_summary_io_v5.py",
    POSTERIOR_ROOT_RELATIVE / "tuning_trace_artifact_v5.py",
    POSTERIOR_ROOT_RELATIVE / "tuning_lossless_emission_store_v5.py",
    POSTERIOR_ROOT_RELATIVE / "paper_representative_history_v5.py",
    POSTERIOR_ROOT_RELATIVE / "paper_representative_history_store_v5.py",
    POSTERIOR_ROOT_RELATIVE / "paper_checkpoint_selector_v5.py",
    POSTERIOR_ROOT_RELATIVE / "paper_budget_evaluator_v5.py",
    POSTERIOR_ROOT_RELATIVE / "k1_phase_c_contract_v5.py",
    POSTERIOR_ROOT_RELATIVE / "k1_phase_c_plan_v5.py",
    POSTERIOR_ROOT_RELATIVE / "k1_phase_c_stress_v5.py",
    POSTERIOR_ROOT_RELATIVE / "k1_phase_c_holdout_recipe_v5.py",
    POSTERIOR_ROOT_RELATIVE / "k1_phase_c_holdout_shard_v5.py",
    POSTERIOR_ROOT_RELATIVE / "k1_phase_c_holdout_launch_plan_v5.py",
    POSTERIOR_ROOT_RELATIVE / "k1_phase_c_holdout_worker_v5.py",
    POSTERIOR_ROOT_RELATIVE / "slurm/v5_k1_phase_c_holdout_cpu.sbatch",
    POSTERIOR_ROOT_RELATIVE / "k1_phase_c_holdout_collector_v5.py",
    POSTERIOR_ROOT_RELATIVE / "slurm/v5_k1_phase_c_holdout_collect_cpu.sbatch",
    POSTERIOR_ROOT_RELATIVE / "launch_k1_phase_c_holdout_dag_v5.py",
    POSTERIOR_ROOT_RELATIVE / "k1_iid_calibration_plan_v5.py",
    POSTERIOR_ROOT_RELATIVE / "k1_iid_calibration_shard_v5.py",
    POSTERIOR_ROOT_RELATIVE / "k1_iid_calibration_launch_plan_v5.py",
    POSTERIOR_ROOT_RELATIVE / "k1_iid_calibration_worker_v5.py",
    POSTERIOR_ROOT_RELATIVE / "slurm/v5_k1_iid_calibration_cpu.sbatch",
    POSTERIOR_ROOT_RELATIVE / "k1_iid_calibration_collector_v5.py",
    POSTERIOR_ROOT_RELATIVE / "slurm/v5_k1_iid_calibration_collect_cpu.sbatch",
    POSTERIOR_ROOT_RELATIVE / "launch_k1_iid_calibration_dag_v5.py",
    POSTERIOR_ROOT_RELATIVE / "k1_branch_forcing_v5.py",
    POSTERIOR_ROOT_RELATIVE / "k1_balanced_dataset_plan_v5.py",
    POSTERIOR_ROOT_RELATIVE / "k1_forced_sobol_recipe_v5.py",
    POSTERIOR_ROOT_RELATIVE / "k1_forced_universal_query_v5.py",
    POSTERIOR_ROOT_RELATIVE / "k1_balanced_full_search_parent_v5.py",
    POSTERIOR_ROOT_RELATIVE / "k1_balanced_full_search_plan_v5.py",
    POSTERIOR_ROOT_RELATIVE / "k1_balanced_full_search_plan_runtime_v5.py",
    POSTERIOR_ROOT_RELATIVE / "author_k1_balanced_full_search_plan_v5.py",
    POSTERIOR_ROOT_RELATIVE
    / "slurm/v5_k1_balanced_full_search_plan_author_cpu.sbatch",
    POSTERIOR_ROOT_RELATIVE / "k1_balanced_full_search_authorization_v5.py",
    POSTERIOR_ROOT_RELATIVE / "k1_balanced_full_search_runtime_v5.py",
    POSTERIOR_ROOT_RELATIVE / "k1_balanced_full_search_worker_v5.py",
    POSTERIOR_ROOT_RELATIVE / "k1_balanced_full_search_collector_v5.py",
    POSTERIOR_ROOT_RELATIVE / "k1_balanced_full_search_replay_v5.py",
    POSTERIOR_ROOT_RELATIVE / "k1_search_training_inputs_v5.py",
    POSTERIOR_ROOT_RELATIVE / "k1_search_projection_evidence_v5.py",
    POSTERIOR_ROOT_RELATIVE / "tuning_reference_executor_v5.py",
    POSTERIOR_ROOT_RELATIVE / "launch_k1_balanced_full_search_dag_v5.py",
    ...
    POSTERIOR_ROOT_RELATIVE / "build_k1_balanced_grouped_shard_v5.py",
    POSTERIOR_ROOT_RELATIVE / "k1_dataset_disjointness_v5.py",
    POSTERIOR_ROOT_RELATIVE / "k1_balanced_dataset_launch_plan_v5.py",
    POSTERIOR_ROOT_RELATIVE / "k1_balanced_dataset_worker_v5.py",
    POSTERIOR_ROOT_RELATIVE / "slurm/v5_k1_balanced_dataset_cpu.sbatch",
    POSTERIOR_ROOT_RELATIVE / "k1_balanced_dataset_collector_v5.py",
    POSTERIOR_ROOT_RELATIVE / "slurm/v5_k1_balanced_dataset_collect_cpu.sbatch",
    POSTERIOR_ROOT_RELATIVE / "launch_k1_balanced_dataset_dag_v5.py",
...
def _formal_blockers(inventory: Mapping[str, object], mode: str) -> list[str]:
    ...
    if mode != "formal_multiseed":
        return blockers
    if not inventory["splits"]["train_and_tuning_are_disjoint_from_k1_phase_c"]:
        blockers.append(
            "input inventory has no replayed train/tuning/Phase-C identity authorization"
        )
